...
ROOT_DIR = os.getcwd()
MODEL_DIR = os.path.join(ROOT_DIR, "logs\shapes20220509T2214\\")
...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        """
        # Add classes
        self.add_class("shape", 1, "pig")  # 脆性区域
        ...
        for i in range(count):
            ...
            self.add_image("shape", image_id=i, path=img_floder + "/" + imglist[i],
...
# 测试集设置
dataset_root_path="D:\\bishe\\zhutu\\train_data1\\"
...
model_path = os.path.join(MODEL_DIR, "mask_rcnn_shapes_0010.h5")  # 修改成自己训练好的模型
 
# Load trained weights
print("Loading weights from ", model_path)
model.load_weights(model_path, by_name=True)
 
img_list = np.random.choice(dataset_test.image_ids, 10)
APs = []
count1 = 0
